          ...
          <div className="absolute right-0 top-0 bottom-0 w-full max-w-[40vw] bg-white shadow-2xl modal-enter overflow-hidden border border-gray-200 
            ...
            {showPaymentPopup && popupMessage && (
              <>
                ...
                <div 
                  className="absolute inset-0 z-[59] bg-black/60 backdrop-blur-[2px]"
                  ...
                  <div className="relative rounded-2xl shadow-2xl p-5 sm:p-6 max-w-md w-full pointer-events-auto animate-fade-in-up border-2"
                       style={{
                         background: popupMessage.type === 'extra'
                           ? '#331500'
                           : '#0B1C15',
                         borderColor: popupMessage.type === 'extra'
                    ...
                    <button
                      onClick={() => setShowPaymentPopup(false)}
                      className="absolute top-3 right-3 w-6 h-6 flex items-center justify-center rounded-full transition-all hover:scale-110 bg-white/10 hover:bg-white/20 text-white/80 hover:text-white"
                    >
                    ...
                    <div className="flex flex-col items-center text-center space-y-4">
                      {/* Status Badge */}
                      <div className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-semibold bg-white/10 text-white/90 backdrop-blur-sm">
                      ...
                      <div className="relative flex items-center justify-center">
                        <div className="relative w-20 h-20 sm:w-24 sm:h-24 flex items-center justify-center">
                          <img 
                            ...
                            style={{ filter: 'drop-shadow(0 8px 16px rgba(255, 255, 255, 0.3))' }}
                          />
                        </div>
                        {/* Amount Badge */}
                        <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 px-3 py-1 rounded-full shadow-lg bg-white/20 backdrop-blur-sm border border-white/30">
                          <span className="text-sm font-bold text-white">₹{popupMessage.amount.toLocaleString()}</span>
                        </div>
                      </div>
                      ...
                      {popupMessage.type === 'saving' ? (
                        <div className="w-full space-y-2.5">
                          ...
                          <div className="text-center">
                            ...
                            <p className="text-xs text-white/70">Smart choice! You&apos;re getting the best deal with online payment.</p>
                          </div>
                          ...
                          <div className="bg-white/10 rounded-lg p-2.5 border border-white/20 backdrop-blur-sm">
                            <div className="flex items-center justify-center gap-3 sm:gap-4 flex-wrap">
                              <div className="flex items-center gap-1.5 text-xs">
                                <svg className="w-3.5 h-3.5 text-white/90 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                              ...
                              <svg className="w-3.5 h-3.5 text-white/90 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                                ...
                                <span className="text-white/90 font-medium">Bank Offers</span>
                              </div>
                              <div className="flex items-center gap-1.5 text-xs">
                              <svg className="w-3.5 h-3.5 text-white/90 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                                </svg>
                                <span className="text-white/90 font-medium">Cashbacks</span>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="w-full space-y-2.5">
                          ...
                          <div className="bg-white/10 rounded-lg p-2.5 border border-white/20 backdrop-blur-sm">
                            <div className="flex items-center justify-center gap-2">
                              <svg className="w-4 h-4 text-white/90" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5">
                                <path strokeLinecap="round" strokeLinejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6" />
                              </svg>
                              <span className="text-xs text-white/90 font-medium">Switch to Razorpay and save</span>
                              <span className="text-sm font-bold text-white">₹{popupMessage.savings?.toLocaleString()}</span>
                            </div>
                          </div>
                        </div>
                      )}
